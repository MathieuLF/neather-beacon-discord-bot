...
const validateBotEnvironment = (env = process.env, { requireDiscord = true } = {}) => {
  ...
  const normalized = {
    ...
    BOT_POKEAPI_CACHE_TTL_DAYS: parsePositiveInteger(env.BOT_POKEAPI_CACHE_TTL_DAYS, 30, { min: 1, max: 365 }),
    BOT_POKEAPI_MAX_ASSET_BYTES: parsePositiveInteger(env.BOT_POKEAPI_MAX_ASSET_BYTES, 5 * 1024 * 1024, { min: 65536, max: 10 * 1024 * 1024 }),
    BOT_POKEAPI_MAX_JSON_BYTES: parsePositiveInteger(env.BOT_POKEAPI_MAX_JSON_BYTES, 1024 * 1024, { min: 65536, max: 2 * 1024 * 1024 }),
    BOT_POKEAPI_MAX_MEMORY_ENTRIES: parsePositiveInteger(env.BOT_POKEAPI_MAX_MEMORY_ENTRIES, 64, { min: 16, max: 256 }),
    BOT_POKEAPI_MAX_CACHE_BYTES: parsePositiveInteger(env.BOT_POKEAPI_MAX_CACHE_BYTES, 256 * 1024 * 1024, { min: 32 * 1024 * 1024, max: 1024 * 1024 * 1024 }),
    BOT_POKEAPI_MAX_CACHE_FILES: parsePositiveInteger(env.BOT_POKEAPI_MAX_CACHE_FILES, 512, { min: 64, max: 4096 }),
    BOT_POKEAPI_MAX_CONCURRENT_REQUESTS: parsePositiveInteger(env.BOT_POKEAPI_MAX_CONCURRENT_REQUESTS, 4, { min: 1, max: 8 }),
    BOT_POKEAPI_GLOBAL_COOLDOWN_MS: parsePositiveInteger(env.BOT_POKEAPI_GLOBAL_COOLDOWN_MS, 1000, { min: 250, max: 10000 }),
